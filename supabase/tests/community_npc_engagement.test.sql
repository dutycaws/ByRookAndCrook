...
insert into private.npc_versions(id,npc_id,version_number,sheet,sheet_hash,state,published_at) values
  ('18500000-3000-4000-8000-000000000001','18500000-2000-4000-8000-000000000001',1,'{}','engagement-community-v1','published',now()),
  ('18500000-3000-4000-8000-000000000002','18500000-2000-4000-8000-000000000002',1,'{}','engagement-first-party-v1','published',now());

insert into private.world_npc_instances(id,save_id,npc_id,version_id,arrived_day) values
  ('18500000-4000-4000-8000-000000000001','18500000-1000-4000-8000-000000000001','18500000-2000-4000-8000-000000000001','18500000-3000-4000-8000-000000000001',7),
  ('18500000-4000-4000-8000-000000000002','18500000-1000-4000-8000-000000000001','18500000-2000-4000-8000-000000000002','18500000-3000-4000-8000-000000000002',7);
...
insert into private.world_npc_quest_events(id,instance_id,day,outcome,narration) values
  ('18500000-5000-4000-8000-000000000001','18500000-4000-4000-8000-000000000001',7,'succeeded','A bounded success.'),
  ('18500000-5000-4000-8000-000000000002','18500000-4000-4000-8000-000000000001',8,'failed','A bounded failure.'),
  ('18500000-5000-4000-8000-000000000003','18500000-4000-4000-8000-000000000001',9,'abandoned','A bounded abandonment.'),
  ('18500000-5000-4000-8000-000000000004','18500000-4000-4000-8000-000000000001',10,'settled','A bounded completion.');
...
insert into private.world_npc_dialogue_turns(id,save_id,instance_id,npc_id,version_id,actor_id,message,input_sequence,source_revision,day_number,status,lease_until)
  values('18500000-6000-4000-8000-000000000001','18500000-1000-4000-8000-000000000001','18500000-4000-4000-8000-000000000001','18500000-2000-4000-8000-000000000001','18500000-3000-4000-8000-000000000001','18500000-0000-4000-8000-000000000001','No raw dialogue in analytics.',0,0,7,'processing',now());
...
insert into private.world_npc_hospitality_events(save_id,action_id,actor_id,instance_id,item_kind,food_id,input_expected_revision,day_number,item_name,quality_index,gold_earned,relationship_change,result,committed_revision)
  values('18500000-1000-4000-8000-000000000001','18500000-7000-4000-8000-000000000001','18500000-0000-4000-8000-000000000001','18500000-4000-4000-8000-000000000001','food','18500000-7100-4000-8000-000000000001',0,7,'Fixture loaf',3,6,1,'{}',1);
...
update private.world_npc_instances set status='dismissed',dismissed_day=7 where id='18500000-4000-4000-8000-000000000001';
update private.world_npc_instances set status='dismissed' where id='18500000-4000-4000-8000-000000000001';
