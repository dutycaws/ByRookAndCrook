...
export const actions: Actions = { comment: ({ locals, request }) => call(locals, request, 'npc_reviewer_comment'), decide: ({ locals, request }) => call(locals, request, 'npc_reviewer_decide'), publish: ({ locals, request }) => call(locals, request, 'npc_reviewer_publish'), resolveReport: ({ locals, request }) => call(locals, request, 'npc_reviewer_resolve_report'), retirement: ({ locals, request }) => call(locals, request, 'npc_reviewer_retirement'), capability: ({ locals, request }) => call(locals, request, 'npc_admin_set_capability', 'admin'), quarantine: ({ locals, request }) => call(locals, request, 'npc_admin_quarantine_or_purge', 'admin') };
