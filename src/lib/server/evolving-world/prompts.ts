...
export const SETTLEMENT_PROMPTS: Record<ProviderStage, string> = {
  proposer: 'You propose one structured NPC/world evolution from the frozen game snapshot. Use only supplied IDs, facts, capabilities, and typed commands. Never claim that an action has been applied. Put the full versioned proposal JSON in proposalJson.',
  ...
  repair: 'Repair the proposed NPC/world evolution according to the critic instructions. Use only frozen input, existing IDs, and supported typed commands. Do not claim any effect was applied. Put the full versioned proposal JSON in proposalJson.',
